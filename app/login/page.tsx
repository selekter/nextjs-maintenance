...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] px-5 py-8">
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-5xl overflow-hidden rounded-3xl bg-white shadow-xl shadow-slate-900/10 lg:grid-cols-2">
        ...
        <section className="flex items-center p-7 sm:p-12">
          <form onSubmit={handleSubmit} className="w-full max-w-sm mx-auto">
            ...
            <p className="text-sm font-semibold text-teal-700">เข้าสู่ระบบ</p>
            <h2 className="mt-2 text-3xl font-bold tracking-tight text-[#102a43]">
              ยินดีต้อนรับ
            </h2>
            <p className="mt-2 text-sm text-slate-500">
              กรอกข้อมูลเพื่อเข้าสู่แดชบอร์ด
            </p>
            {error && (
              <p
                role="alert"
